        ...
        if os.path.isdir(folder_path) and folder != 'hooks':
            ...
            if spec_name:
                ...
                with open(api_page_full_path, "w", encoding="utf-8") as f:
                    ...
                    # Параметры скрывают интерактивный клиент и боковую панель Scalar, оставляя только чистый контент
                    f.write(f'<scalar src="{absolute_spec_url}" data-hide-test-client="true" data-show-sidebar="false"/>\n')
